...
- [x] TASK: worldmonitor-parity-analysis | Target: docs/backlog.md | I/O: documentation | Assert: lists all features from worldmonitor.app to replicate | LOC: ~20
  - Conflict & security (ACLED, UCDP, geopolitical hotspots)
  - Maritime & trade (AIS vessel tracking, shipping chokepoints)
  - Aviation & aerospace (ADS-B, satellite passes SGP4, GPS jamming)
  - Energy & infrastructure (pipelines, AI datacenters, submarine cables)
  - Markets & macro (exchanges, FRED, IMF, BIS)
  - Climate & natural hazards (NASA FIRMS, USGS earthquakes)
  - Cyber & connectivity (Ransomware, BGP hijack, DDoS)
...
## Phase 4: Integration, Ecosystem & Resilience (Pending & Prioritized)
