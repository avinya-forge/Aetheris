...
assert.strictEqual(Array.isArray(result), true, 'probability-cones.test.js assertion failed');
assert.strictEqual(result.length, 2, 'probability-cones.test.js assertion failed');

const firstCard = result[0];
assert.strictEqual(firstCard.likelihood >= 0 && firstCard.likelihood <= 100, true, 'probability-cones.test.js assertion failed');
assert.strictEqual(firstCard.speculative, false, 'probability-cones.test.js assertion failed');
assert.strictEqual(firstCard.eventDetails.eventType, 'Heatwave', 'probability-cones.test.js assertion failed');
assert.strictEqual(firstCard.eventDetails.location, 'Paris', 'probability-cones.test.js assertion failed');
