...
try {
  ...
  assert.strictEqual(parseKpIndex(null), null, 'null input should return null');
  assert.strictEqual(parseKpIndex({}), null, 'empty object should return null');
  assert.strictEqual(parseKpIndex({ kp_index: 'not-a-number' }), null, 'invalid string should return null');
  assert.strictEqual(parseKpIndex([] as any), null, 'array input should return null');
