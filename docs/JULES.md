...
## 1. Core Directives
1. **SSOT Supremacy**: Every code change must be reflected in `backlog.md` and `README.md`. Never allow documentation to drift from implementation.
...
1. **Plan**: Identify tasks in `backlog.md`.
