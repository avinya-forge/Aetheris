...
try {
  ...
  assert.strictEqual(mappedArt.impactScore, 10, 'news-mapper.test.js assertion failed');
  assert.strictEqual(mappedArt.source, 'gdelt', 'news-mapper.test.js assertion failed');
