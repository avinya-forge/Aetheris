...
const backlog = state.find(doc => doc.path === 'docs/planning/backlog.md');
assert.ok(backlog);
assert.strictEqual(backlog.exists, true);

const conventions = state.find(doc => doc.path === 'docs/engineering/conventions.md');
...
const backlog2 = state2.find(doc => doc.path === 'docs/planning/backlog.md');
assert.ok(backlog2);
assert.strictEqual(backlog2.exists, true);
