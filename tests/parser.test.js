...
assert.strictEqual(nonExistent, undefined, 'parser.test.js: expected values to be strictly equal'); // We aren't testing missing items here unless we define required paths
