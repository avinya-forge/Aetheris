 ...
 */
function scoreSource(sourceMeta, now = Date.now()) {
 ...
 */
function rankSources(sourcesMeta, now = Date.now()) {
  return sourcesMeta
...
module.exports = { scoreSource, rankSources, SOURCE_BASE_INTERVALS_MS };
