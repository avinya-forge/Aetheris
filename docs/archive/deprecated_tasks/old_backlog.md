...
- [BLOCKED] TASK: implement-chromodynamic-logic | Target: lib/ui/chromodynamic.js | I/O: Kp-Index -> ColorSpec | Assert: 0 err, >95% cov | LOC: ~40
- [BLOCKED] TASK: design-vector-glyphs | Target: assets/glyphs/index.svg | I/O: void -> SVG | Assert: Clean-SVG | LOC: ~100
- [BLOCKED] TASK: init-mapbox-gl | Target: components/map/atlas.tsx | I/O: Config -> MapInstance | Assert: 0 err | LOC: ~60
- [BLOCKED] TASK: implement-layer-zoom-logic | Target: lib/ui/zoom-controller.js | I/O: ZoomLevel -> LayerVisibility | Assert: 0 err, >95% cov | LOC: ~30
- [BLOCKED] TASK: render-3d-map-timeline | Target: components/map/timeline.tsx | I/O: Props -> ReactElement | Assert: 0 err, >95% cov | LOC: ~120
- [BLOCKED] TASK: render-ghost-cards | Target: components/ui/ghost-card.tsx | I/O: ProbabilityData -> ReactElement | Assert: 0 err, >95% cov | LOC: ~50
